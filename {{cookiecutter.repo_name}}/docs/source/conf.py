...
# -*- coding: utf-8 -*-
#
# CWR-API documentation build configuration file, created by
# sphinx-quickstart on Thu Mar 26 12:35:16 2015.
#
...
man_pages = [
    (master_doc, '{{ cookiecutter.distribution_name }}', '{{ cookiecutter.project_name }} Documentation',
     [','.join(authors)], 1)
]
...
texinfo_documents = [
    (master_doc, '{{ cookiecutter.project_name }}', '{{ cookiecutter.project_name }} Documentation',
     ','.join(authors), '{{ cookiecutter.project_name }}', '{{ cookiecutter.project_short_description }}',
     'Miscellaneous'),
]
